...
int f = 0;
        ...
        String e_otp=txtOTP.getText().trim();
        ...
        String emergencyPOC = txtEmergencyName.getText().trim();
        String emergencyPOC_Num = txtEmergencyContactNumber.getText().trim();
        String sign = txtSignature.getText().trim();
...
if(!zipCode.matches("^[0-9]{5}(?:-[0-9]{4})?$")){
                JOptionPane.showMessageDialog(null, "Please enter 5 digit zip code");
                     return;
                 }
if(!ssn.matches("^[0-9]{4}$")){
...
//             }
    ...
    private void btnVerifyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerifyActionPerformed
        // TODO add your handling code here:
        String entered_otp=txtOTP.getText().trim();
