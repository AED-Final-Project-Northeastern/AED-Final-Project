...
public class NetworkManagementJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnAddCity.setFont(new java.awt.Font("Trebuchet MS", 1, 18)); // NOI18N
    ...
    private void btnAddCityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddCityActionPerformed
        ...
        if (name.matches("^([A-Za-z]+)(\\s[A-Za-z]+)*\\s?$")) {
            ...
            if(!state.matches("^([A-Za-z]+)(\\s[A-Za-z]+)*\\s?$"))
            {
            ...
            {
              JOptionPane.showMessageDialog(null, "Enter 5 digit zip code");
              return;
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (name.matches("^([A-Za-z]+)(\\s[A-Za-z]+)*\\s?$")) {
            ...
            if(f==0){
                int selectedRowIndex = tblNetworkDetails.getSelectedRow();
                if (selectedRowIndex <0){
                    JOptionPane.showMessageDialog(this, "Please Select a row to delete");
                    return;
                }
                DefaultTableModel model = (DefaultTableModel) tblNetworkDetails.getModel();
                Network network  = (Network)model.getValueAt(selectedRowIndex, 0);
            ...
            JOptionPane.showMessageDialog(null,"No special characters are allowed");
        }
...
//gets values from table and deletes it using delete methods from system
